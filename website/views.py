...
@login_required
def home():
    return render_template("home.html", user = current_user, CryptoPrice = open("/home/ThockeyA5/website/codefiles/Price.CC.txt").read())
...
def mine():
    if request.method == 'POST':
        ...
        CryptoCode = open("/home/ThockeyA5/website/codefiles/CodeCC.txt").read()
        if code == CryptoCode:
    ...
    if request.method == 'POST':
      ...
      if not buy.isdigit():
          ...
          if int(buy) < 1:
              ...
              CryptoPrice = open("/home/ThockeyA5/website/codefiles/Price.CC.txt").read()
